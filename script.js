...
const translations = {
  en: {
    ...
    text: {
      ...
      "brand.location": "Klang / Kapar, Selangor",
      ...
      "hero.eyebrow": "Aircond shop near Klang and Kapar, Selangor",
      ...
      "services.title": "Aircond sales, installation, servicing, washing and repair in Klang and Kapar.",
      ...
      "trust.title": "Straightforward help from a local Klang / Kapar aircond shop.",
      ...
      "answers.a2": "Yes. The shop supports homes, offices, shop lots and small business cooling needs around Klang, Kapar and Selangor.",
      ...
      "facts.area.value": "Klang and Kapar, Selangor, including Taman Sungai Kapar Indah",
      "facts.contact.label": "Contact",
      "footer.copy": "Aircond sales, installation, service, washing and repair in Klang / Kapar, Selangor.",
  ...
  ms: {
    ...
    text: {
      ...
      "hero.eyebrow": "Kedai aircond berhampiran Klang dan Kapar, Selangor",
      ...
      "services.title": "Jualan, pemasangan, servis, cuci dan baiki aircond di Klang dan Kapar.",
      ...
      "trust.title": "Bantuan aircond yang mudah dari kedai tempatan di kawasan Klang / Kapar.",
      ...
      "answers.a2": "Ya. Kedai ini menyokong rumah, pejabat, lot kedai dan keperluan penyejukan perniagaan kecil sekitar Klang, Kapar dan Selangor.",
      ...
      "facts.area.value": "Klang dan Kapar, Selangor, termasuk Taman Sungai Kapar Indah",
      "facts.contact.label": "Hubungi",
      "footer.copy": "Jualan, pemasangan, servis, cuci dan baiki aircond di Klang / Kapar, Selangor.",
  ...
  zh: {
    ...
    text: {
      ...
      "intro.body":
        "Seng Soon Aircond 帮助巴生与 Kapar 一带的住家、办公室和店铺保持冷气凉爽、干净并正常运作。客户可询问新机、安装、定期保养、普通或深层清洗、故障检查、维修、零件以及状况良好的二手冷气。",
      "intro.note1": "提供住家、办公室和店铺的冷气销售、安装、维修、清洗及保养服务。",
      "intro.note2": "也售卖冷气零件，并收购/出售状况良好的二手冷气，视库存而定。",
      "services.eyebrow": "服务项目",
      "services.title": "巴生与 Kapar 冷气销售、安装、保养、清洗与维修。",
      ...
      "trust.title": "来自巴生 / Kapar 本地冷气店的直接帮助。",
      ...
      "answers.a2": "可以。店铺支持巴生、Kapar 和雪兰莪一带的住家、办公室、店铺和小型生意冷气需求。",
      "answers.q3": "有卖冷气零件吗？",
      ...
      "facts.area.value": "巴生与 Kapar，雪兰莪，包括 Taman Sungai Kapar Indah",
      "facts.contact.label": "联系",
      "footer.copy": "巴生 / Kapar，雪兰莪冷气销售、安装、保养、清洗与维修服务。",
